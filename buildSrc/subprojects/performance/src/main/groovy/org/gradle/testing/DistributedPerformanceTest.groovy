...
class DistributedPerformanceTest extends ReportGenerationPerformanceTest {
    ...
    private void schedule(Scenario scenario, String lastChangeId) {
        ...
        logger.info("Scheduling $scenario.id, estimated runtime: $scenario.estimatedRuntime, coordinatorBuildId: $buildId, lastChangeId: $lastChangeId, build request: $requestBody")
